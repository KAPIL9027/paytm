...
const SigninComponent = () => {
  ...
  return (
    <div
      className="w-screen h-screen flex flex-row justify-evenly p-2 bg-[#E5E5E5] items-center"
    ...
    >
      ...
      <form className="w-full md:w-1/2 lg:w-1/3 h-[450px] lg:h-[500px] bg-[#FFFFFF] rounded-lg p-8 flex flex-col justify-between lg:gap-0">
        <div className="flex flex-col gap-1 lg:gap-4 mb-2">
          <h1 className="lg:w-[229px] font-bold text-[#6358DC] text-3xl">
            <span className="text-black font-normal text-xl">Welcome to</span> PayTM
          </h1>
        ...
        <div className="flex flex-col gap-8">
          <div>
            <FormInput
              ...
              LabelIcon={<UserIcon width="16px" height="16px" />}
              type="text"
              label="Full Name"
          ...
          <div>
            <FormInput
              ...
              LabelIcon={<Phone width="16px" height="16px" />}
              type="text"
              label="Phone number"
          ...
          <div>
            <FormInput
              ...
              LabelIcon={<PasswordIcon width="16px" height="16px" />}
              type="password"
              label="Password"
          ...
          <button
            className="w-full bg-[#6358DC] text-white p-2 cursor-pointer hover:rounded-lg transition-all"
            onClick={async (e) => {
              e.preventDefault();
